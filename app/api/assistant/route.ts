    ...
    response = await fetch("https://api.anthropic.com/v1/messages", {
      ...
      body: JSON.stringify({
        ...
        system: [
          ...
          "Use mapped complaints, complaints per 1,000, recorded administrative closure, request-age checkpoint, historical replay, expected open balance, net open-workload change, assumption-based workload scenario, selection scenario, priority portfolio size, and hypothesis to investigate.",
